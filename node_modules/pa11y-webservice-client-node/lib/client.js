	...
	return {
		...
		task: function (id) {
			return {
				...
				// Get results for a task homepage
				homeresults: function (query, done) {
					get(root + 'tasks/' + id + '/homeresults', query, done);
				},
...
function req (method, url, query, body, done) {
	//console.log("method: " + method + ", url: " + url + ", query: " + JSON.stringify(query) + ", body: " + body);
	request({
		method: method,
		url: url,
		qs: query,
