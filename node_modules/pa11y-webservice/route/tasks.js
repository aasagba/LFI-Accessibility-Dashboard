	...
	return [
		...
		// Get all tasks
		{
			...
			handler: function (req) {
				//console.log("client in tasks.js: " + JSON.stringify(req.query.client));

				model.task.getAll(req.query.client, function (err, tasks) {
					//console.log("Tasks in tasks.js" + JSON.stringify(tasks));
					...
					if (req.query.lastres) {
						model.result.getAll({}, function (err, results) {
							...
							tasks = tasks.map(function (task) {
								...
								//console.log("Task in tasks.js" + JSON.stringify(task));
