...
module.exports = function (app) {
	...
	return [
		...
		// Get results for a task
		{
			...
			handler: function (req) {
				model.task.getById(req.params.id, function (err, task) {
					//console.log("/tasks/{id}/results id: " + req.params.id);
					...
					model.result.getByTaskId(req.params.id, req.query, function (err, results) {
						//console.log("req.params.id: " + JSON.stringify(req.query));
		...
		// Get latest count results for homepage
		{
			method: 'GET',
			path: '/tasks/{id}/homeresults',
			handler: function (req) {
				model.task.getById(req.params.id, function (err, task) {
					//console.log("/tasks/{id}/results id: " + req.params.id);
					//console.log("task " + task);
					...
					model.result.getLightByTaskId(req.params.id, req.query, function (err, results) {
						//console.log("req.params.id: " + JSON.stringify(req.query));
						//console.log("req.query: " + JSON.stringify(req.query));
						if (err || !results) {
							return req.reply().code(500);
