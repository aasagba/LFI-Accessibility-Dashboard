...
module.exports = function (app, callback) {
	app.db.collection('tasks', function (err, collection) {
		...
		var model = {
			...
			// Get all tasks
			getAll: function (client, skip, searchTerm, callback) {
				//console.log("client in task.js: " + client);
				//console.log("Number of records to skip: " + parseInt(skip));
				var query = {};
				query["client"] = client;
				...
				collection
					...
					.skip(parseInt(skip))
					.limit(100)
					.sort({name: 1, standard: 1, url: 1, client: 1})
